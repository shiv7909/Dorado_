...
import 'package:untitled1/VIEWS/Others/virtualTryOnPage.dart';
import '../../CONTROLLERS/body3/Retriving_controllers/cart_items_retrive_controller.dart';
import '../../CONTROLLERS/body2/product_Functionality/ADD_Favourites_controller.dart';
import '../../CONTROLLERS/body2/product_Functionality/product_Add_in_cart_controller.dart';
import '../../MODELS/constants.dart';
import 'fullimage.dart';
import '../../CONTROLLERS/pageeState_controller.dart';
...
class _ProductDisplayScreenState extends State<ProductDisplayScreen> {
  ...
  final Product_Add_controller product_Add_to_cart_controller =
      Product_Add_controller();
                        ...
                        child: Stack(children: [
                          PageView.builder(
                            ...
                            onPageChanged: (int index) {
                              setState(() {
                                _currentPage =
                                    index % controller.products[0].images.length;
                              });
                            },
                            itemBuilder: (context, index) {
                              return GestureDetector(
                                  ...
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) => FullScreenImage(
                                        imageUrl: controller.products[0].images[
                                            index %
                                                controller
                                ...
                                child: CachedNetworkImage(
                                  imageUrl: controller.products[0].images[index %
                                      controller.products[0].images.length],
                                  fit: controller.products[0].Title == "FOOTWEAR"
                                      ? null
                                      : BoxFit.cover,
                                ),
                              );
                          ...
                          controller.products[0].discount!=0?
                          Positioned(
                              bottom: 5,
                              right: 5,
                              child: Container(
                                ...
                                onTap: () {
                                  isFavorite
                                      ? Fav.removeFromFavorites(
                                          widget.id, widget.varid)
                                      : Fav.addToFavorites(
                                          widget.id, widget.varid, "S");
                                },
                                child: Container(
                                  alignment: Alignment.center,
                                  padding: EdgeInsets.all(10),
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  controller.products[0].nprice!=controller.products[0].oprice?
                                  Text("₹ ${controller.products[0].oprice}",
                                      style: GoogleFonts.plusJakartaSans(
                                        fontWeight: FontWeight.w500,
                                          ...
                                          //color: kTextcolor,
                                          fontSize: 13,
                                          decoration: TextDecoration.lineThrough)):SizedBox.shrink()
                                ],
                              ),
                              SizedBox(
                              ...
                              if (controller.products[0].DimensionalModle != "new_value")
                                GestureDetector(
                                  onTap: () {
                                    Get.to(() => ModelView(link: controller.products[0].DimensionalModle,));
                                  },
                                  child: Container(
                              ...
                              if (controller.products[0].colors.length > 0)
                                Container(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      bool isSelected =
                                          controller.products[0].colors[index] ==
